...
```{r}
sortedDF_reduced$stavba <- as.double(sortedDF_reduced$stavba)
...
dataForRegression$stavba <- as.double(dataForRegression$stavba)
...
dataForRegressionAll$ura <- as.double(dataForRegressionAll$ura)
dataForRegressionAll$stavba <- as.double(dataForRegressionAll$stavba)
