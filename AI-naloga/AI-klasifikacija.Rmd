...
Številke na X osi prikazujejo mesece za katere smo napovedovali in sicer 1 pomeni februar vse do 11, ki pomeni december. Opazimo, da so napake pri izbranih podatkih večje, kar pomeni, da je na splošno model zgrajen iz vseh danih podatkov boljši od tega iz podatkov, ki največ pripomorejo k oceni atributa "poraba". Napake pa seveda iz meseca v mesec variirajo.
...
plot(order(podatkiRegresijaDrevoMaeVsi$mesec), podatkiRegresijaDrevoMaeVsi$napaka,main="VSI PODATKI - REGRESIJSKO DREVO", xlab="MESECI", ylab="SREDNJA ABSOLUTNA NAPAKA", type = "h")
plot(order(podatkiRegresijaDrevoMaeIzbrani$mesec), podatkiRegresijaDrevoMaeIzbrani$napaka,main="IZBRANI PODATKI - REGRESIJSKO DREVO", xlab="MESECI", ylab="SREDNJA ABSOLUTNA NAPAKA", type = "h")
```
...
plot(order(podatkiRegresijaGozdMaeVsi$mesec), podatkiRegresijaGozdMaeVsi$napaka,main="VSI PODATKI - NAKLJUČNI GOZD", xlab="MESECI", ylab="SREDNJA ABSOLUTNA NAPAKA", type = "h")
plot(order(podatkiRegresijaGozdMaeIzbrani$mesec), podatkiRegresijaGozdMaeIzbrani$napaka,main="IZBRANI PODATKI - NAKLJUČNI GOZD", xlab="MESECI", ylab="SREDNJA ABSOLUTNA NAPAKA", type = "h")
```
