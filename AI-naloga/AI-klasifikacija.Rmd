...
Podatke za regresijo se vzame iz že urejenih podatkov "sortedDF" brez "norm_poraba" in se jih faktorizira. Zaradi velike količine podatkov se preveri za vsak mesec posebej(npr. zgoraj za januar).
